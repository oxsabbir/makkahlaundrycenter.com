export function HomeOnePageChromeBefore() {
  return (
<div className="react-fragment">{/*********************************
            ...
            <ul className="sub-menu">
              ...
              <li className="menu-item-has-children">
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <a href="/home/emergency-one-page">Home Emergency Plumbing</a>
                  </li>
                  <li>
                    <a href="/home/residential-one-page">Home Residential Plumbing</a>
                  </li>
                </ul>
              </li>
            </ul>
  ...
  <div className="color-scheme-wrap active">
    ...
    <div className="color-switch-btns">
      <button data-color="#FF4F38">
        <i className="fa-solid fa-droplet" />
      </button>
      <button data-color="#3282FB">
        <i className="fa-solid fa-droplet" />
      </button>
      <button data-color="#6D30FB">
        <i className="fa-solid fa-droplet" />
      </button>
      <button data-color="#27AE60">
        <i className="fa-solid fa-droplet" />
      </button>
      ...
      <div className="widget">
        <div className="th-widget-about">
          ...
          <p className="about-text mb-4">
            Pamar full potential with our comprehensive consulting services.
            Our expert team partners with you to identify growth
            opportunities.
          </p>
          ...
          <div className="recent-post">
            ...
            <div className="media-body">
              ...
              <h4 className="post-title">
                <a className="text-inherit" href="/blog/details">Rapid solutions for your plumbing issues</a>
              </h4>
            </div>
          </div>
          <div className="recent-post">
            ...
            <div className="media-body">
              ...
              <h4 className="post-title">
                <a className="text-inherit" href="/blog/details">Frequent maintenance, such as inspection</a>
              </h4>
            </div>
          </div>
          <div className="recent-post">
            ...
            <div className="media-body">
              ...
              <h4 className="post-title">
                <a className="text-inherit" href="/blog/details">Mastering: Handyman's Guide to Tips &amp; Tricks</a>
              </h4>
            </div>
          </div>
        </div>
      ...
      <div className="widget th-newsletter-widget style4">
        ...
        <form className="newsletter-form">
          ...
          <button type="submit" className="th-btn">
            Subscribe <span className="after-bg" />
          </button>
        </form>
      </div>
    </div>
...
export function HomeOnePageChromeHeader() {
  return (
<div className="react-fragment"><header className="th-header header-default onepage-nav">
          ...
          <div className="header-links d-none d-xxl-inline-block d-lg-inline-block">
            <ul>
              <li className="d-xxl-inline-block">
                <i className="fa-regular fa-clock" />Working Hours: Mon to Fri -
                8:00am - 16:00pm
              </li>
              <li>
                <i className="fal fa-envelope" /><a href="mailto:info@pamar.com">info@pamar.com</a>
              </li>
              <li className="d-xxl-inline-block">
                <i className="fal fa-location-dot" />156 Main Street, 2nd Floor.
                USA
              </li>
            </ul>
          </div>
          ...
          <div className="row align-items-center justify-content-between">
                            ...
                            <div className="col-lg-4">
                              <div className="mega-menu-box">
                                ...
                                <h3 className="mega-menu-title">
                                  <a href="/">Home General Plumbing</a>
                                </h3>
                              </div>
                            </div>
                            <div className="col-lg-4">
                              <div className="mega-menu-box">
                                ...
                                <h3 className="mega-menu-title">
                                  <a href="/home/emergency">Home Emergency Plumbing</a>
                                </h3>
                              </div>
                            </div>
                            <div className="col-lg-4">
                              <div className="mega-menu-box">
                                ...
                                <h3 className="mega-menu-title">
                                  <a href="/home/residential">Home Residential Plumbing</a>
                                </h3>
                              </div>
                            </div>
                          </div>
            ...
            <div className="col-auto d-xl-block d-none">
              <div className="header-button">
                <button type="button" className="icon-btn style6 searchBoxToggler">
                  <i className="far fa-search" />
                </button>
                <a className="th-btn style6" href="tel:+16369729901"><img src="/assets/img/icon/phone.svg" alt />Call Us:
                  +163-6547-9874</a>
                <button type="button" className="icon-btn style6 sideMenuInfo">
...
export function HomeOnePageChromeFooter() {
  return (
            ...
            <div className="widget footer-widget">
              <div className="th-widget-about">
                ...
                <p className="about-text">
                  At Pamar, we are committed to delivering unparalleled
                  quality and precision in every facet of our operations. From
                  the moment you reach out to us, through our expert.
                </p>
          ...
          <div className="col-sm-6 col-xl-auto" data-cue="slideInUp">
            <div className="widget widget_nav_menu footer-widget">
              ...
              <div className="menu-all-pages-container">
                <ul className="menu">
                  <li>
                    <a href="/"><i className="fa-solid fa-angle-right" />Home</a>
                  </li>
                  <li>
                    <a href="/about"><i className="fa-solid fa-angle-right" />About Us</a>
                  </li>
                  <li>
                    <a href="/pricing"><i className="fa-solid fa-angle-right" />Pricing Plan</a>
                  </li>
                  <li>
                    <a href="/projects"><i className="fa-solid fa-angle-right" />Our Gallery</a>
                  </li>
                  <li>
                    <a href="/contact"><i className="fa-solid fa-angle-right" />Our Location</a>
                  </li>
                  <li>
                    <a href="/blog"><i className="fa-solid fa-angle-right" /> Blog</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-md-6 col-xl-auto" data-cue="slideInUp">
            <div className="widget widget_nav_menu footer-widget">
              ...
              <div className="menu-all-pages-container">
                <ul className="menu">
                  <li>
                    <a href="/services"><i className="fa-solid fa-angle-right" /> Burst Pipe
                      Repair</a>
                  </li>
                  <li>
                    <a href="/services"><i className="fa-solid fa-angle-right" /> Drain
                      Unclogging</a>
                  </li>
                  <li>
                    <a href="/services"><i className="fa-solid fa-angle-right" /> Water Heater
                      Fixes</a>
                  </li>
                  <li>
                    <a href="/services"><i className="fa-solid fa-angle-right" /> Sewer Backup</a>
                  </li>
                  <li>
                    <a href="/services"><i className="fa-solid fa-angle-right" /> Leak
                      Detection</a>
                  </li>
                  <li>
                    <a href="/services"><i className="fa-solid fa-angle-right" /> Gas Line
                      Emergencies</a>
                  </li>
                </ul>
              </div>
        ...
        <div className="row justify-content-center gy-3 align-items-center">
          <div className="col-lg-6" data-cue="slideInUp">
            <p className="copyright-text">
              ...
              <a href="/">Pamar</a>, All rights reserved.
            </p>
          </div>
...
export function HomeOnePageChromeAfter() {
  return (
<div className="react-fragment">{/*********************************
			Code End  Here 
	******************************** */}

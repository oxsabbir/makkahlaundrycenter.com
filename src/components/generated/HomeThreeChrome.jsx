export function HomeThreeChromeBefore() {
  return (
...
export function HomeThreeChromeHeader() {
  return (
<div className="react-fragment"><header className="th-header header-layout3">
...
export function HomeThreeChromeFooter() {
  return (
...
export function HomeThreeChromeAfter() {
  return (
<div className="react-fragment">{/*********************************
			Code End  Here 
	******************************** */}

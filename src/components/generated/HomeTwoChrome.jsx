export function HomeTwoChromeBefore() {
  return (
...
export function HomeTwoChromeHeader() {
  return (
<div className="react-fragment"><header className="th-header header-layout1">
    <div className="header-top">
      <div className="row justify-content-center justify-content-xl-between  align-items-center gy-2">
        ...
        <div className="col-auto d-none d-xxl-block d-xl-block ">
          ...
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-auto">
              ...
              <div className="header-button d-flex d-lg-none">
                <button type="button" className="th-menu-toggle icon-btn style7"><i className="far fa-bars" /></button>
              </div>
            </div>
...
export function HomeTwoChromeFooter() {
  return (
...
export function HomeTwoChromeAfter() {
  return (
<div className="react-fragment">{/*********************************
			Code End  Here 
	******************************** */}

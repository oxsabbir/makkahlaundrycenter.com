          ...
          <div className="widget  ">
            <div className="th-widget-about">
              ...
              <p className="about-text mb-4">
                {" "}
                Makkah Laundry Center offers premium laundry and dry cleaning
                services with free pickup &amp; delivery. We treat your garments
                with expert care, using eco-friendly methods.
              </p>
              <div className="th-social style2">
                ...
                <a href="https://wa.me/966569385700" target="_blank">
            ...
            <div className="recent-post-wrap">
              ...
              <div className="recent-post">
                ...
                <div className="media-body">
                  ...
                  <h4 className="post-title">
                    <a className="text-inherit" href="/blog/details">
                      Mastering: Handyman's Guide to Tips &amp; Tricks
                    </a>
                  </h4>
                </div>
              </div>
                ...
                <div className="col-auto d-xl-block d-none">
                  <div className="header-button">
                    ...
                    >
                      ...
                      WhatsApp: +966 56 938 5700
                    </a>
                    {/* <button
                      type="button"
                      className="icon-btn style6 sideMenuInfo"
                    >
              ...
              <div className="col-xxl-9 col-xl-8">
                <div className="title-area mb-0">
                  <h2 className="text-white text-anim2">
                    Schedule your first pickup today — free delivery!
                  </h2>
                </div>
              </div>
                ...
                <div className="widget footer-widget">
                  <div className="th-widget-about">
                    ...
                    <p className="about-text">
                      At Makkah Laundry Center, we are committed to delivering
                      premium laundry and dry cleaning services with care and
                      precision. Free pickup &amp; delivery, eco-friendly
                      washing, and expert stain treatment.
                    </p>
                ...
                <div className="widget widget_nav_menu footer-widget">
                  ...
                  <div className="menu-all-pages-container">
                    <ul className="menu">
                      <li>
                        <a href="/services">
                          <i className="fa-solid fa-angle-right" /> Wash &amp;
                          Fold
                        </a>
                      </li>
                      <li>
                        <a href="/services">
                          <i className="fa-solid fa-angle-right" /> Dry Cleaning
                        </a>
                      </li>
                      <li>
                        <a href="/services">
                          <i className="fa-solid fa-angle-right" /> Ironing
                          &amp; Pressing
                        </a>
                      </li>
                      <li>
                        <a href="/services">
                          <i className="fa-solid fa-angle-right" /> Stain
                          Removal
                        </a>
                      </li>
                      <li>
                        <a href="/services">
                          <i className="fa-solid fa-angle-right" /> Curtain
                          &amp; Bedding
                        </a>
                      </li>
                      <li>
                        <a href="/services">
                          <i className="fa-solid fa-angle-right" /> Free Pickup
                          &amp; Delivery
                        </a>
                      </li>
                    </ul>

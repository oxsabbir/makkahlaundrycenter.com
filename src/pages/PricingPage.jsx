...
export default function PricingPage() {
  return (
    <PageLayout
      variant="default"
      title="Shared on THEMELOCK.COM - Pamar - Plumbing & Repair Service HTML Template - Pricing Plan"
...
==============================*/}
  <section className="space position-relative overflow-hidden">
      ...
      <div className="row justify-content-center">
        <div className="col-xl-6">
          <div className="title-area text-center">
            <span className="sub-title2 bg-gray-color " data-cue="slideInUp">Pricing Plan</span>
            <h2 className="sec-title style6 text-anim2" data-cue="slideInUp">Affordable Plumbing <span>Pricing</span> &amp; offers</h2>
          </div>
        </div>
      </div>
      <div className="row gy-30">
        <div className="col-xl-4 col-md-6" data-cue="slideInUp">
          <div className="price-card style2 style4 ">
            ...
            <div className="price_card-wrap">
              ...
              <div className="btn-wrap">
                <a href="/contact" className="th-btn">Choose Plan <span className="after-bg" /></a>
              </div>
            </div>
          </div>
        </div>
        <div className="col-xl-4 col-md-6" data-cue="slideInUp">
          <div className="price-card style2 style4 active">
    ...
    <div className="shape-mockup jump d-none d-xxl-block " style={{bottom: '0%', right: '0%'}}>
...
Faq Area
==============================*/}
  <div className="overflow-hidden bg-gray-color space overflow-hidden position-relative z-index-2">
    <div className="container">
...
==============================*/}
          <div className="faq-wrap1">
            <div className="accordion" id="faqAccordion">
              <div className="accordion-card style4" data-cue="slideInUp">

    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-12">
          <form action="#" className="woocommerce-form-login mb-3">
            ...
            <div className="form-group">
              <button type="submit" className="th-btn btn-sm login">Login <span className="after-bg" /></button>
      ...
      <div className="row">
        <div className="col-12">
          <form action="#" className="woocommerce-form-coupon">
            ...
            <div className="form-group">
              <button type="submit" className="th-btn btn-sm ">Apply coupon <span className="after-bg" /></button>
            </div>
          </form>
        </div>
      </div>
      <form action="#" className="woocommerce-checkout mt-40">
        <div className="row ">
          <div className="col-lg-6">
            <h2 className="h4 fw-semibold">Billing Details</h2>
            <div className="row">
          ...
          <div className="col-lg-6">
            <p id="ship-to-different-address">
              <input id="ship-to-different-address-checkbox" type="checkbox" name="ship_to_different_address" defaultValue={1} defaultChecked />
            ...
            <div className="col-12 form-group style-border">
              <textarea cols={20} rows={5} className="form-control" placeholder="Notes about your order, e.g. special notes for delivery." defaultValue={""} />
            </div>
          </div>
        </div>
      </form>
      <h4 className="mt-4 pt-lg-2 fw-semibold">Your Order</h4>
        ...
        <table className="cart_table mb-20">
          ...
          <tbody>
            <tr className="cart_item">
              ...
              <td data-title="Name">
                <a className="cart-productname" href="/shop/details">Business Board</a>
              </td>
              <td data-title="Price">
      ...
      <div className="mt-lg-3 mb-30">
        <div className="woocommerce-checkout-payment">
          ...
          <div className="form-row place-order">
            <button type="submit" className="th-btn btn-sm ">Place order <span className="after-bg" /></button>
          </div>
        </div>
      </div>
    </div>

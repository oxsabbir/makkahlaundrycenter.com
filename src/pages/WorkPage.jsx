              ...
              <div className="col-xl-6 col-lg-7">
                <div className="box-content">
                  ...
                  <div>
                    ...
                    <p className="box-text mb-45">When it comes to plumbing, you need more than just a quick fix — you need a team you can trust. At [Your Company Name], we bring years of experience, professional expertise, and a commitment to quality craftsmanship to every job.</p>
            ...
            <div className="row gy-40 gx-50 align-items-center">
              ...
              <div className="col-xl-6 col-lg-7">
                <div className="box-content">
                  ...
                  <div>
                    <h3 className="box-title">Finale works and cleaning</h3>
                    <p className="box-text mb-45">When it comes to plumbing, you need more than just a quick fix — you need a team you can trust. At [Your Company Name], we bring years of experience, professional expertise, and a commitment to quality craftsmanship to every job.</p>
                    <a href="/about" className="th-btn style3">
                      Discover More
                      <span className="after-bg" />

          ...
          <div className="container">
            ...
            <div className="row gy-60">
              <div className="col-12">
                <div className="work-card2" data-cue="slideInUp">
                  <div className="row gy-40 gx-50 align-items-center">
                    <div className="col-xl-5 col-lg-5">
                      <div className="box-image">
                        <img src="/assets/img/normal/why-thumb3-1.jpg" alt />
                      </div>
                    </div>
                    <div className="col-xl-6 col-lg-7">
                      <div className="box-content">
                        ...
                        <div>
                          <h3 className="box-title">Inspection</h3>
                          <p className="box-text mb-45">
                            When it comes to plumbing, you need more than just a
                            quick fix — you need a team you can trust. At [Your
                            Company Name], we bring years of experience,
                            professional expertise, and a commitment to quality
                            craftsmanship to every job.
                          </p>
                          <a href="/about" className="th-btn style3">
                            Discover More
              ...
              <div className="col-12">
                <div className="work-card2" data-cue="slideInUp">
                  <div className="row gy-40 gx-50 align-items-center">
                    <div className="col-xl-5 col-lg-5">
                      <div className="box-image">
                        <img src="/assets/img/normal/why-thumb3-2.jpg" alt />
                      </div>
                    </div>
                    <div className="col-xl-6 col-lg-7">
                      <div className="box-content">
              ...
              <div className="col-12">
                <div className="work-card2" data-cue="slideInUp">
                  <div className="row gy-40 gx-50 align-items-center">
                    <div className="col-xl-5 col-lg-5">
                      <div className="box-image">
                        <img src="/assets/img/normal/why-thumb3-3.jpg" alt />
                      </div>
                    </div>
                    <div className="col-xl-6 col-lg-7">
                      <div className="box-content">
                        ...
                        <div>
                          <h3 className="box-title">Fix And install</h3>
                          <p className="box-text mb-45">
                            When it comes to plumbing, you need more than just a
                            quick fix — you need a team you can trust. At [Your
                            Company Name], we bring years of experience,
              ...
              <div className="col-12">
                <div className="work-card2" data-cue="slideInUp">
                  <div className="row gy-40 gx-50 align-items-center">
                    <div className="col-xl-5 col-lg-5">
                      <div className="box-image">
                        <img src="/assets/img/normal/why-thumb3-4.jpg" alt />
                      </div>
                    </div>
                    <div className="col-xl-6 col-lg-7">
                      <div className="box-content">

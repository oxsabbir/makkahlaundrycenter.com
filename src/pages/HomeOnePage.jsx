                ...
                <div className="feature-card" data-cue="slideInUp">
                  ...
                  <div className="feature-card-details text-left">
                    ...
                    <p className="box-text">
                      Skilled, certified &amp; continuously educated plumbers
                      voluptuous selenite antique corrupted.
                    </p>
                  ...
                  <div className="about-wrap" data-cue="slideInUp">
                    <div className="title-area mb-40">
                      <p>
                        ...
                        reliable, and long-lasting solutions for both
                        residential and commercial needs. Whether it’s a leaky
                        faucet, clogged drain, burst pipe, or a full plumbing
                        installation, our team of licensed plumbers is equipped
                        with the tools
                      </p>
                    </div>
                ...
                <div className="swiper-slide">
                  <div className="marquee-card">
                    ...
                    <a
                      target="_blank"
                      href="#"
                      data-hover="Electrical Services"
                    >
                      Electrical Services
                    </a>
                  </div>
...
==============================*/}
        <section
          className="space bg-smoke overflow-hidden bg-gray-color service-wrap mb-40"
          id="service-sec"
        >
          <div
              ...
              <div>
                ...
                <div className=" ">
                  <div className="text-xxl-end text-xl-end text-lg-end text-start">
                    <span
                      className="sub-title style2 after-none before-none"
                      data-cue="slideInUp"
                    >
                      OUR SERVICES
                    </span>
                ...
                <div>
                  <div
                    className="title-area-right text-start"
                    data-cue="slideInUp"
                  >
                    <p className="mb-0">
                      Our plumbing services are designed to provide fast,
          ...
          <div className="slider-area service-slider">
            <div
              className="swiper th-slider"
              id="serviceSlider"
              data-slider-options='{"paginationType":"progressbar","breakpoints":{"0":{"slidesPerView":1},"767":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"3"},"1600":{"slidesPerView":"3"}}}'
            >
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="service-card">
                    <div className="d-flex justify-content-between">
                      <div className="box-icon">
                        <div className="color-masking">
                          <img
                            src="/assets/img/icon/service/service_icon_1_1.svg"
                            alt="icon"
                          />
                        </div>
                      </div>
                      <a href="/services" className="circle-tag">
                        ...
                        <div className="icon">
                          <img
                            src="/assets/img/icon/right-arrow-theme1.svg"
                            alt
                          />
                        </div>
                      </a>
                    ...
                    <p className="box-text">
                      From leaky faucets to running toilets, we handle all types
                      of plumbing repairs to keep your home or business running
                      smoothly.
                    </p>
                  </div>
                  <div className="service-card style1">
                    ...
                    <div className="box-img">
                      <img
                        src="/assets/img/service/service_card_4_1.jpg"
                        alt="image"
                      />
                    </div>
                  </div>
                ...
                <div className="swiper-slide">
                  <div className="service-card">
                    <div className="d-flex justify-content-between">
                      <div className="box-icon">
                        <div className="color-masking">
                          <img
                            src="/assets/img/icon/service/service_icon_1_2.svg"
                            alt="icon"
                          />
                        </div>
                      </div>
                  ...
                  <div className="service-card style1">
                    ...
                    <div className="box-img">
                      <img
                        src="/assets/img/service/service_card_4_2.jpg"
                        alt="image"
                      />
                    </div>
                  </div>
                ...
                <div className="swiper-slide">
                  <div className="service-card">
                    <div className="d-flex justify-content-between">
                      <div className="box-icon">
                        <div className="color-masking">
                          <img
                            src="/assets/img/icon/service/service_icon_1_3.svg"
                            alt="icon"
                          />
                        </div>
                      </div>
                    ...
                    <p className="box-text">
                      Installation and repair of faucets, sinks, showers,
                      bathtubs, dishwashers &amp; garbage disposals for
                  ...
                  <div className="service-card style1">
                    ...
                    <div className="box-img">
                      <img
                        src="/assets/img/service/service_card_4_3.jpg"
                        alt="image"
                      />
                    </div>
                  </div>
                ...
                <div className="swiper-slide">
                  <div className="service-card">
                    <div className="d-flex justify-content-between">
                      <div className="box-icon">
                        <div className="color-masking">
                          <img
                            src="/assets/img/icon/service/service_icon_1_4.svg"
                            alt="icon"
                          />
                        </div>
                      </div>
                  ...
                  <div className="service-card style1">
                    ...
                    <div className="box-img">
                      <img
                        src="/assets/img/service/service_card_4_4.jpg"
                        alt="image"
                      />
                    </div>
                  </div>
                ...
                <div className="swiper-slide">
                  <div className="service-card">
                    <div className="d-flex justify-content-between">
                      <div className="box-icon">
                        <div className="color-masking">
                          <img
                            src="/assets/img/icon/service/service_icon_1_5.svg"
                            alt="icon"
                          />
                        </div>
                      </div>
                  ...
                  <div className="service-card style1">
                    ...
                    <div className="box-img">
                      <img
                        src="/assets/img/service/service_card_4_5.jpg"
                        alt="image"
                      />
                    </div>
                  </div>
                ...
                <div className="swiper-slide">
                  <div className="service-card">
                    <div className="d-flex justify-content-between">
                      <div className="box-icon">
                        <div className="color-masking">
                          <img
                            src="/assets/img/icon/service/service_icon_1_6.svg"
                            alt="icon"
                          />
                        </div>
                      </div>
                  ...
                  <div className="service-card style1">
                    ...
                    <div className="box-img">
                      <img
                        src="/assets/img/service/service_card_4_6.jpg"
                        alt="image"
                      />
                    </div>
                  </div>
              ...
              <div className="slider-pagination-wrap">
                ...
                <div className="icon-box">
                  <button
                    data-slider-prev="#serviceSlider"
                    className="slider-arrow style3 default"
                  >
                    <img src="/assets/img/icon/left-arrow.svg" alt />
                  </button>
                  <button
                    data-slider-next="#serviceSlider"
                    className="slider-arrow style3 default"
                  >
                    <img src="/assets/img/icon/right-arrow.svg" alt />
                  </button>
...
==============================*/}
        <section className="overflow-hidden" id="project-sec">
            ...
            <div className="title-area text-xl-start text-center">
              <div className="row justify-content-between">
                ...
                <div className="col-xxl-3 col-xl-4">
                  <div
                    className="mt-30 text-xl-end text-xxl-end"
                    data-cue="slideInLeft"
                  >
          ...
          <div className="slider-area">
            <div
              className="swiper th-slider marquee-slider2 mb-2"
              data-slider-options='{"breakpoints":{"0":{"slidesPerView":"auto"}},"autoplay":{"delay":0,"disableOnInteraction":false},"noSwiping":"false","speed":10000,"spaceBetween":12}'
            >
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                ...
                <div className="swiper-slide">
                  <div className="project-card">
                    <div className="box-img">
                      <img
                        src="/assets/img/project/project1-2.jpg"
                        alt="project image"
                      />
                    </div>
                    <div className="box-content">
                ...
                <div className="swiper-slide">
                  <div className="project-card">
                    <div className="box-img">
                      <img
                        src="/assets/img/project/project1-3.jpg"
                        alt="project image"
                      />
                    </div>
                    <div className="box-content">
                ...
                <div className="swiper-slide">
                  <div className="project-card">
                    <div className="box-img">
                      <img
                        src="/assets/img/project/project1-4.jpg"
                        alt="project image"
                      />
                    </div>
                    <div className="box-content">
                ...
                <div className="swiper-slide">
                  <div className="project-card">
                    <div className="box-img">
                      <img
                        src="/assets/img/project/project1-6.jpg"
                        alt="project image"
                      />
                    </div>
                    <div className="box-content">
                ...
                <div className="swiper-slide">
                  <div className="project-card">
                    <div className="box-img">
                      <img
                        src="/assets/img/project/project1-7.jpg"
                        alt="project image"
                      />
                    </div>
                    <div className="box-content">
                ...
                <div className="swiper-slide">
                  <div className="project-card">
                    <div className="box-img">
                      <img
                        src="/assets/img/project/project1-8.jpg"
                        alt="project image"
                      />
                    </div>
                    <div className="box-content">
                ...
                <div className="swiper-slide">
                  <div className="project-card">
                    <div className="box-img">
                      <img
                        src="/assets/img/project/project1-9.jpg"
                        alt="project image"
                      />
                    </div>
                    <div className="box-content">
            ...
            <div
              className="swiper th-slider marquee-slider2"
              dir="rtl"
              data-slider-options='{"breakpoints":{"0":{"slidesPerView":"auto"}},"autoplay":{"delay":0,"disableOnInteraction":false,"reverseDirection": false},"noSwiping":"false","speed":10000,"spaceBetween":12}'
            >
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="project-card">
          ...
          <div className="container">
            ...
            <div className="row gy-4">
              ...
              <div className="order-xxl-3 order-5 col-xl-4 col-lg-4 col-md-6 align-self-center text-center">
                <a
                  href="/team"
                  className="circle-btn th-btn mt-xl-0 mt-30"
                  data-cue="slideInUp"
                >
                  Join With Us
                </a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4">
                      <div className="process-card" data-cue="slideInUp">
                        <div className="box-content">
                          ...
                          <p className="box-text">
                            When booking, it helps customers when they are shown
                            a calendar.
                          </p>
                        </div>
              ...
              <div className="row justify-content-center align-items-center">
                <div className="col-xxl-12">
                  <div className="title-area text-center pt-1">
                    <span
                      className="sub-title text-anim after-none before-none"
                      data-cue="slideInUp"
                    >
                    ...
                    <div className="price_card-wrap">
                      ...
                      <div className="checklist">
                        <ul>
                          <li>
                            <img
                              src="/assets/img/icon/check-icon1-3.svg"
                              alt="img"
                            />
                ...
                <div className="col-xl-4 col-md-6" data-cue="slideInUp">
                  <div className="price-card">
                    <div className="box-top">
                      ...
                      <div className="box-image">
                        <img
                          src="/assets/img/price/price_1_3.jpg"
                          alt="price"
                        />
                      </div>
                    </div>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6">
                    ...
                    <p className="sec-text" data-cue="slideInUp">
                      Whether it’s a small repair or a major installation, our
                      team of licensed and experienced plumber is committed to
                      getting the job done right — the first time. We use modern
                      tools
                    </p>
                  </div>
                </div>
                    ...
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="testi-card">
                          ...
                          <p className="box-text">
                            With transparent pricing, fast response times, and
                            24/7 emergency availability, we’re always here when
                            you need us. Our customer-first approach means we
                            treat every job with care, cleanliness, and
                            professionalism.
                          </p>

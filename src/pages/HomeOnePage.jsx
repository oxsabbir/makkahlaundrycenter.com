            ...
            <div className="container">
              <div className="hero-style1">
                <span className="sub-title style5" data-ani="slideinup" data-ani-delay="0.2s">
                  Professional Laundry &amp; Dry Cleaning Services</span>
                ...
                <p className="hero-text text-white" data-ani="slideinup" data-ani-delay="0.6s">
                  Free pickup &amp; delivery. Same-day turnaround. Premium care
                  for all your fabrics — because your clothes deserve the
                  best.
                </p>
        ...
        <div className="swiper-slide" data-bg-src="/assets/img/hero/hero_bg_1_2.jpg">
          <div className="hero-inner">
            <div className="container">
              <div className="hero-style1">
                <span className="sub-title style5" data-ani="slideinup" data-ani-delay="0.2s">
                  Expert Care for Every Fabric</span>
                <h1 className="hero-title text-white">
          ...
          <div className="feature-card" data-cue="slideInUp">
            ...
            <div className="feature-card-details text-left">
              ...
              <p className="box-text">
                Skilled, certified &amp; continuously educated plumbers voluptuous
                selenite antique corrupted.
              </p>
      ...
      <div className="about-wrap1">
        <div className="title-area">
          <div className="row gx-60 justify-content-center align-items-start">
            ...
            <div className="col-auto">
              <div className="text-center">
                <h2 className="sec-title style2 text-anim2 mb-0" data-cue="slideInUp">
                  About Us
                </h2>
              </div>
            </div>
            ...
            <div className="img-box1" data-cue="slideInUp" data-delay={300}>
              ...
              <div className="circle-tag d-none d-xxl-block">
                ...
                <h2 className="box-number">
                  <span className="counter-number">12</span><span className="counter-marker">+</span>
                </h2>
              </div>
            </div>
          </div>
          <div className="col-xxl-6 col-xl-6 col-lg-6">
            <div className="about-wrap" data-cue="slideInUp">
              <div className="title-area mb-40">
                <p>
                  Our plumbing services are designed to provide fast,
                  reliable, and long-lasting solutions for both residential
                  and commercial needs. Whether it’s a leaky faucet, clogged
                  drain, burst pipe, or a full plumbing installation, our team
                  of licensed plumbers is equipped with the tools
                </p>
              </div>
...
==============================*/}
  <section className="space bg-smoke overflow-hidden bg-gray-color service-wrap mb-40" id="service-sec">
        ...
        <div>
          ...
          <div className=" ">
            <div className="text-xxl-end text-xl-end text-lg-end text-start">
              ...
              <h2 className="sec-title style3 style7 mb-0" data-cue="slideInUp">
                We Provide Best Plumbing <br />
          ...
          <div>
            <div className="title-area-right text-start" data-cue="slideInUp">
              <p className="mb-0">
                Our plumbing services are designed to provide fast, reliable,
                and long-lasting solutions for both residential and commercial
                needs. Whether it’s a leaky faucet, clogged drain, burst pipe,
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="slider-area service-slider">
      <div className="swiper th-slider" id="serviceSlider" data-slider-options="{&quot;paginationType&quot;:&quot;progressbar&quot;,&quot;breakpoints&quot;:{&quot;0&quot;:{&quot;slidesPerView&quot;:1},&quot;767&quot;:{&quot;slidesPerView&quot;:&quot;2&quot;},&quot;1200&quot;:{&quot;slidesPerView&quot;:&quot;3&quot;},&quot;1300&quot;:{&quot;slidesPerView&quot;:&quot;3&quot;},&quot;1600&quot;:{&quot;slidesPerView&quot;:&quot;3&quot;}}}">
        <div className="swiper-wrapper">
          <div className="swiper-slide">
            <div className="service-card">
              <div className="d-flex justify-content-between">
                <div className="box-icon">
                  <div className="color-masking">
                    <img src="/assets/img/icon/service/service_icon_1_1.svg" alt="icon" />
                  </div>
                </div>
                <a href="/services" className="circle-tag">
                  <span className="circle-title-anime">READ MORE . READ MORE .</span>
                  <div className="icon">
              ...
              <h3 className="box-title">
                <a href="/services">General Plumbing Repairs</a>
              </h3>
              <p className="box-text">
                From leaky faucets to running toilets, we handle all types of
                plumbing repairs to keep your home or business running
                smoothly.
              </p>
            </div>
            <div className="service-card style1">
              ...
              <div className="box-img">
                <img src="/assets/img/service/service_card_4_1.jpg" alt="image" />
              </div>
            </div>
          </div>
          <div className="swiper-slide">
            <div className="service-card">
              <div className="d-flex justify-content-between">
                <div className="box-icon">
                  <div className="color-masking">
                    <img src="/assets/img/icon/service/service_icon_1_2.svg" alt="icon" />
                  </div>
                </div>
                <a href="/services" className="circle-tag">
                  <span className="circle-title-anime">READ MORE . READ MORE .</span>
              ...
              <h3 className="box-title">
                <a href="/services">Drain Cleaning Services</a>
              </h3>
              <p className="box-text">
                Clogged sinks, showers, or toilets? We provide fast and
                effective drain cleaning using the latest tools and
                techniques.
              </p>
            </div>
            <div className="service-card style1">
              ...
              <div className="box-img">
                <img src="/assets/img/service/service_card_4_2.jpg" alt="image" />
              </div>
            </div>
          </div>
          <div className="swiper-slide">
            <div className="service-card">
              <div className="d-flex justify-content-between">
                <div className="box-icon">
                  <div className="color-masking">
                    <img src="/assets/img/icon/service/service_icon_1_3.svg" alt="icon" />
                  </div>
                </div>
                <a href="/services" className="circle-tag">
                  <span className="circle-title-anime">READ MORE . READ MORE .</span>
              ...
              <h3 className="box-title">
                <a href="/services">Bathroom &amp; Kitchen Plumbing</a>
              </h3>
              <p className="box-text">
                Installation and repair of faucets, sinks, showers, bathtubs,
                dishwashers &amp; garbage disposals for residential and commercial
                properties.
              </p>
            </div>
            <div className="service-card style1">
              ...
              <div className="box-img">
                <img src="/assets/img/service/service_card_4_3.jpg" alt="image" />
              </div>
            </div>
          </div>
          <div className="swiper-slide">
            <div className="service-card">
              <div className="d-flex justify-content-between">
                <div className="box-icon">
                  <div className="color-masking">
                    <img src="/assets/img/icon/service/service_icon_1_4.svg" alt="icon" />
                  </div>
                </div>
                <a href="/services" className="circle-tag">
                  <span className="circle-title-anime">READ MORE . READ MORE .</span>
            ...
            <div className="service-card style1">
              ...
              <div className="box-img">
                <img src="/assets/img/service/service_card_4_4.jpg" alt="image" />
              </div>
            </div>
          </div>
          <div className="swiper-slide">
            <div className="service-card">
              <div className="d-flex justify-content-between">
                <div className="box-icon">
                  <div className="color-masking">
                    <img src="/assets/img/icon/service/service_icon_1_5.svg" alt="icon" />
                  </div>
                </div>
                <a href="/services" className="circle-tag">
                  <span className="circle-title-anime">READ MORE . READ MORE .</span>
            ...
            <div className="service-card style1">
              ...
              <div className="box-img">
                <img src="/assets/img/service/service_card_4_5.jpg" alt="image" />
              </div>
            </div>
          </div>
          <div className="swiper-slide">
            <div className="service-card">
              <div className="d-flex justify-content-between">
                <div className="box-icon">
                  <div className="color-masking">
                    <img src="/assets/img/icon/service/service_icon_1_6.svg" alt="icon" />
                  </div>
                </div>
                <a href="/services" className="circle-tag">
                  <span className="circle-title-anime">READ MORE . READ MORE .</span>
            ...
            <div className="service-card style1">
              ...
              <div className="box-img">
                <img src="/assets/img/service/service_card_4_6.jpg" alt="image" />
              </div>
            </div>
          </div>
        </div>
        <div className="slider-pagination-wrap">
          ...
          <div className="icon-box">
            <button data-slider-prev="#serviceSlider" className="slider-arrow style3 default">
              <img src="/assets/img/icon/left-arrow.svg" alt />
            </button>
            <button data-slider-next="#serviceSlider" className="slider-arrow style3 default">
              <img src="/assets/img/icon/right-arrow.svg" alt />
            </button>
          </div>
        </div>
              ...
              <div className="col-xxl-6 col-lg-6 col-md-6">
                <div className="why-card" data-cue="slideInUp">
                  ...
                  <div className="box-details">
                    ...
                    <p className="box-text">
                      When it comes to plumbing, you need more than just.
                    </p>
                  </div>
                  <div className="skill-feature-wrap mt-60">
                    <div className="skill-feature">
                      ...
                      <div className="progress">
                        <div className="progress-bar bg-theme" style={{width: '92%'}} />
                ...
                <div className="why-card" data-cue="slideInUp">
                  ...
                  <div className="box-details">
                    <h4 className="box-title">
                      Modern Tools &amp; Digital Technology
                    </h4>
                    <p className="box-text">
                      When it comes to plumbing, you need more than just.
                    </p>
...
Project Area  
==============================*/}
  <section className="overflow-hidden" id="project-sec">
    <div className="container">
      <div className="title-area text-xl-start text-center">
        <div className="row justify-content-between">
          <div className="col-xl-auto">
            <h2 className="sub-title style2 text-anim after-none before-none justify-content-xl-start justify-content-center" data-cue="slideInLeft">
              Case Studies
            </h2>
          </div>
          ...
          <div className="col-xl-5">
            <h2 className="sec-title style2 text-anim2 mb-0" data-cue="slideInLeft">
              Projects
            </h2>
          </div>
          <div className="col-xxl-3 col-xl-4">
            <div className="mt-30 text-xl-end text-xxl-end" data-cue="slideInLeft">
              <a href="/projects" className="th-btn style3">
                View All Projects
                <span className="after-bg" />
              </a>
            </div>
    ...
    <div className="slider-area">
      <div className="swiper th-slider marquee-slider2 mb-2" data-slider-options="{&quot;breakpoints&quot;:{&quot;0&quot;:{&quot;slidesPerView&quot;:&quot;auto&quot;}},&quot;autoplay&quot;:{&quot;delay&quot;:0,&quot;disableOnInteraction&quot;:false},&quot;noSwiping&quot;:&quot;false&quot;,&quot;speed&quot;:10000,&quot;spaceBetween&quot;:12}">
        <div className="swiper-wrapper">
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-1.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
                  <h3 className="box-title">
                    <a href="/projects/details">Plumbing Diagnosis</a>
                  </h3>
                </div>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-2.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-3.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-4.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-5.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-6.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-7.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-8.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
          ...
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
                <img src="/assets/img/project/project1-9.jpg" alt="project image" />
              </div>
              <div className="box-content">
                <div>
                  <p className="box-subtitle">Kitchen</p>
      ...
      <div className="swiper th-slider marquee-slider2" dir="rtl" data-slider-options="{&quot;breakpoints&quot;:{&quot;0&quot;:{&quot;slidesPerView&quot;:&quot;auto&quot;}},&quot;autoplay&quot;:{&quot;delay&quot;:0,&quot;disableOnInteraction&quot;:false,&quot;reverseDirection&quot;: false},&quot;noSwiping&quot;:&quot;false&quot;,&quot;speed&quot;:10000,&quot;spaceBetween&quot;:12}">
        <div className="swiper-wrapper">
          <div className="swiper-slide">
            <div className="project-card">
              <div className="box-img">
              ...
              <div className="box-content text-start style2">
                <a href="/projects/details" className="icon-btn style2">
                  <img src="/assets/img/icon/arrow-right-white.svg" alt />
                </a>
                <div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-4">
                <div className="process-card" data-cue="slideInUp">
                  <div className="box-content">
                    ...
                    <p className="box-text">
                      When booking, it helps customers when they are shown a
                      calendar.
                    </p>
                  </div>
        ...
        <div className="row gy-30 justify-content-center">
            ...
            <div className="price-card">
              ...
              <div className="price_card-wrap">
                <h4 className="price-card_price">
                  $290<span className="duration">/month</span>
                </h4>
                <div className="checklist">
                  <ul>
                    <li>
                      <img src="/assets/img/icon/check-icon1-3.svg" alt="img" />
          ...
          <div className="col-xl-4 col-md-6" data-cue="slideInUp">
            <div className="price-card active">
              ...
              <div className="price_card-wrap">
                <h4 className="price-card_price">
                  $390<span className="duration">/month</span>
                </h4>
                <div className="checklist">
                  <ul>
                    <li>
          ...
          <div className="col-xl-4 col-md-6" data-cue="slideInUp">
            <div className="price-card">
              <div className="box-top">
                <div className="box-content">
                  <h3 className="box-title">Premium Package</h3>
                  <p className="box-subtitle" />
                </div>
                <div className="box-image">
              ...
              <div className="price_card-wrap">
                <h4 className="price-card_price">
                  $490<span className="duration">/month</span>
                </h4>
                <div className="checklist">
                  <ul>
                    <li>
          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              ...
              <p className="sec-text" data-cue="slideInUp">
                Whether it’s a small repair or a major installation, our team
                of licensed and experienced plumber is committed to getting
                the job done right — the first time. We use modern tools
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="testi-card">
                    ...
                    <p className="box-text">
                      With transparent pricing, fast response times, and 24/7
                      emergency availability, we’re always here when you need
                      us. Our customer-first approach means we treat every job
                      with care, cleanliness, and professionalism.
                    </p>
                    <div className="testi-card-profile">
                      <div className="testi-card-profile-detaile">
                        <h3 className="box-title">Alex Johansson</h3>
                        <p className="box-desig">Client of USA.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div>
          <div className=" ">
            <div className="text-xxl-end text-xl-end text-lg-end text-start">
              ...
              <h2 className="sec-title style3 mb-0" data-cue="slideInUp">
                Latest News &amp; Blog
              </h2>
            </div>
          </div>
        ...
        <div className="col-xl-4 col-lg-6" data-cue="slideInUp">
          <div className="blog-card position-relative">
            ...
            <div className="blog-content">
              ...
              <h3 className="box-title">
                <a href="/blog/details">Achieving calm minds from plumbing issues
                </a>
              </h3>
        ...
        <div className="col-xl-4 col-lg-6" data-cue="slideInUp">
          <div className="blog-card position-relative">
            ...
            <div className="blog-content">
              ...
              <h3 className="box-title">
                <a href="/blog/details">Expert Tips &amp; Stories from the Plumbing World</a>
              </h3>
              <a href="/blog/details" className="link-btn">
                Read More
                <span className="after-bg" />
        ...
        <div className="col-xl-4 col-lg-6" data-cue="slideInUp">
          <div className="blog-card position-relative">
            ...
            <div className="blog-content">
              <span className="box-tag">Kitchen Plumbing</span>
              <h3 className="box-title">
                <a href="/blog/details">Solving Everyday Plumbing Challenges with Ease</a>
              </h3>
              <a href="/blog/details" className="link-btn">
                Read More
                <span className="after-bg" />

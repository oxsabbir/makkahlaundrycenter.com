              ...
              <div className="row gx-40 gy-30 mb-24">
                    ...
                    <div className="team-card-content">
                      <div>
                        <h3 className="box-title">
                          <a href="#">Jordan Smith</a>
                        </h3>
                        <span className="box-subtitle">Engineer</span>
                      </div>
                      <div className="team-social">
                        <button
                          className="icon-btn style2 style-border2"
                          tabIndex={0}
                        >
                          <i className="fa-solid fa-plus" />
                        </button>
                        <div className="th-social style12">
                          <a href="http://facebook.com" tabIndex={0}>
                            <i className="fab fa-facebook-f" />
                          </a>
                          <a href="http://twitter.com" tabIndex={0}>
                            <i className="fab fa-twitter" />
                          </a>
                          <a href="http://instagram.com" tabIndex={0}>
                ...
                <div className="col-xxl-8 col-xl-8">
                  <div className="page-single">
                    ...
                    <p className="mb-0">
                      Hello, This Jordan Smith , Professional about variations
                    ...
                    <p>
                      “Appreciated the courtesy &amp; promptness to addressing
                      my issues. Worked with a sense of urgency for a resolution
                      in my unplanned plumbing emergency. Repairs were done in a
                      timely, professional manner and with thoroughness &amp;
                      care by the experienced technician.”
                    </p>
                    ...
                    <div className="row gy-40 justify-content-center">
                        ...
                        >
                          ...
                          <div className="box-content">
                            <p className="box-text">
                              <a href="tel:+4733378901">+09 (123) 456 7890</a>
                            </p>
                            <p className="box-text">
                              <a href="tel:+4733378901">+09 (123) 456 7890</a>
                            </p>
                      ...
                      <div className="col-xl-4 col-lg-4">
                        ...
                        >
                          ...
                          <div className="box-content">
                            <p className="box-text">
                              <a href="mailto:help24/7.info@pamar.com">
                                infomail@example.com
                              </a>
                            </p>
                            <p className="box-text">
                              <a href="mailto:help24/7.info@pamar.com">
              ...
              <div className="row gx-40 gy-40">
                <div className="col-xxl-8 col-xl-8">
                  <div className="box-content">
                    ...
                    <p className="mb-20">
                      The culmination of this transformative endeavor marked the
                      dawn of a new era for the office space, where meticulous
                      attention to detail and an unwavering commitment to
                      excellence converged to create an environment that
                      transcended mere functionality.
                    </p>
                    <p className="mb-50">
                      Through an intricate and strategic overhaul of the
                      office's electrical infrastructure, our dedicated team
                      orchestrated a symphony of technological innovation and
                  ...
                  <div className="skill-wrap">
                    ...
                    <div className="skill-feature style3">
                      <div className="skill-feature">
                        <h3 className="skill-feature_title">
                          Effective Project Manage <span>80%</span>
                        </h3>
                        <div className="progress">
                          <div
                            className="progress-bar bg-theme"
                    ...
                    <div className="skill-feature style3">
                      <div className="skill-feature">
                        <h3 className="skill-feature_title">
                          Consulting &amp; Planning <span>85%</span>
                        </h3>
                        <div className="progress">
                          <div
                            className="progress-bar bg-theme"
                    ...
                    <div className="skill-feature style3">
                      <div className="skill-feature">
                        <h3 className="skill-feature_title">
                          High Communication Skilled <span>95%</span>
                        </h3>
                        <div className="progress">
                          <div
                            className="progress-bar bg-theme"
                ...
                <div className="col-xxl-4 col-xl-4 col-xl-6">
                  <div className="testi-card style6">
                    ...
                    <p className="box-text">
                      Communication before and during the repair was helpful,
                      since we were unsure how extensive it might be once the
                      area was dug out. We would highly recommend both Mike and
                      Chris. Repairs were done in a timely,
                    </p>
                  </div>
                </div>
              </div>
...
==============================*/}
        <div
          className="space  contact-area-1 position-relative z-index-common"
          id="contact-sec"
        >
          <div className="container">
                ...
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <a href="/blog" className="brand-box">
                      <img
                        src="/assets/img/brand/brand3-1.svg"
                        alt="Brand Logo"
                      />
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="/blog" className="brand-box">
                      <img
                        src="/assets/img/brand/brand3-2.svg"
                        alt="Brand Logo"
                      />
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="/blog" className="brand-box">
                      <img
                        src="/assets/img/brand/brand3-3.svg"
                        alt="Brand Logo"
                      />
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="/blog" className="brand-box">
                      <img
                        src="/assets/img/brand/brand3-4.svg"
                        alt="Brand Logo"
                      />
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="/blog" className="brand-box">
                      <img
                        src="/assets/img/brand/brand3-5.svg"
                        alt="Brand Logo"
                      />
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="/blog" className="brand-box">
                      <img
                        src="/assets/img/brand/brand3-6.svg"
                        alt="Brand Logo"
                      />
                    </a>
                  </div>
